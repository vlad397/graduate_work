...
class PersonFilmWork(UUIDMixin, models.Model):
    ...
    role = models.CharField(_("role"), max_length=10, choices=Role.choices, null=True)
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=["film_work", "person", "role"], name="unique_person_and_role_for_film_work")
        ]
